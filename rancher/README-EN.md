...
- one replica in the official `cattle-system` namespace;
...
If Rancher rejects the password after a reinstall, reset the `admin` account and resynchronize the local Secrets:
